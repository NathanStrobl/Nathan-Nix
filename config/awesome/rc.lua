...
globalkeys = gears.table.join(
    ...
    end, {description = "close window in focus", group = "custom"}
    ),
...
awful.rules.rules = {
    ...
    -- Remove borders from Pcmanfm (desktop manager) and polybar.
    { 
      rule = { class = "Pcmanfm" },
      properties = { border_width = 0, border_color = "#000000" }
    },
...
--	    if width < c.screen.workarea.width and height < c.screen.workarea.height then
--		    c:geometry({
--			    width = width + 20,
--			    height = height + 20,
--	            })
